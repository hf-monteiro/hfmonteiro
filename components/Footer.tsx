        ...
        <div className="py-10 text-sm text-zinc-400">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div className="flex flex-col gap-2">
              <a className="hover:text-[var(--signal)]" href={`${base}/case-studies`}>{nav.caseStudies}</a>
              <a className="hover:text-[var(--signal)]" href={`${base}/labs`}>{nav.labs}</a>
              <a className="hover:text-[var(--signal)]" href={`${base}/skills`}>{nav.skills}</a>
              <a className="hover:text-[var(--signal)]" href={`${base}/resume`}>{nav.resume}</a>
              <a className="hover:text-[var(--signal)]" href={`${base}/contact`}>{nav.contact}</a>
            </div>
          </div>
